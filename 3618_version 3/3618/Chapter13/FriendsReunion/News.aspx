		...
		<form id="Form1" method="post" runat="server">
			<p>
				<asp:panel id="pnlApproved" runat="server">
					...
					<p>
						<asp:datagrid id="grdApproved" runat="server" PageSize="2" AllowPaging="True" AutoGenerateColumns="False" DataSource="<%# dsApproved %>" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" BackColor="White" CellPadding="3" GridLines="Horizontal">
			...
			<p><asp:panel id="pnlPending" runat="server">
					...
					<p>
						<asp:datagrid id="grdPending" runat="server" autogeneratecolumns="False" bordercolor="#999999"
